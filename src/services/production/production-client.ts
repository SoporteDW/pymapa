...
function boundaryFor(capabilityId: string): Boundary {
  ...
  const generic = {
    changeOp01ActivityState: conCapacidad(changeCapabilityActivityState) as typeof changeOp01ActivityState,
    createOp01Activity: conCapacidad(createCapabilityActivity) as typeof createOp01Activity,
    createOp01Intervention: conCapacidad(createCapabilityIntervention) as typeof createOp01Intervention,
    createOp01RecommendationCandidate: conCapacidad(createCapabilityRecommendationCandidate) as typeof createOp01RecommendationCandidate,
    decideOp01Recommendation: conCapacidad(decideCapabilityRecommendation) as typeof decideOp01Recommendation,
    getOp01AssessmentState: conCapacidad(getCapabilityAssessmentState) as typeof getOp01AssessmentState,
    getOp01Collaboration: conCapacidad(getCapabilityCollaboration) as typeof getOp01Collaboration,
    getOp01Findings: conCapacidad(getCapabilityFindings) as typeof getOp01Findings,
    getOp01NextAcquisition: conCapacidad(getCapabilityNextAcquisition) as typeof getOp01NextAcquisition,
    inviteOp01Respondent: conCapacidad(inviteCapabilityRespondent) as typeof inviteOp01Respondent,
    registerOp01Deliverable: conCapacidad(registerCapabilityDeliverable) as typeof registerOp01Deliverable,
    compareOp01Assessments: conCapacidad(compareCapabilityAssessments) as typeof compareOp01Assessments,
    decideOp01FollowUp: conCapacidad(decideCapabilityFollowUp) as typeof decideOp01FollowUp,
    decideOp01Validation: conCapacidad(decideCapabilityValidation) as typeof decideOp01Validation,
    getOp01Validation: conCapacidad(getCapabilityValidation) as typeof getOp01Validation,
    markOp01ActivityDone: conCapacidad(markCapabilityActivityDone) as typeof markOp01ActivityDone,
    openOp01Validation: conCapacidad(openCapabilityValidation) as typeof openOp01Validation,
    registerOp01ValidationCase: conCapacidad(registerCapabilityValidationCase) as typeof registerOp01ValidationCase,
    registerOp01ValidationRequirement: conCapacidad(registerCapabilityValidationRequirement) as typeof registerOp01ValidationRequirement,
    startOp01FollowUp: conCapacidad(startCapabilityFollowUp) as typeof startOp01FollowUp,
    startOp01Reassessment: conCapacidad(startCapabilityReassessment) as typeof startOp01Reassessment,
    registerOp01Evidence: conCapacidad(registerCapabilityEvidence) as typeof registerOp01Evidence,
    reviewOp01Finding: conCapacidad(reviewCapabilityFinding) as typeof reviewOp01Finding,
    submitOp01Response: conCapacidad(submitCapabilityResponse) as typeof submitOp01Response,
  };
